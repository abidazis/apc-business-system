...
<form method="POST" action="{{ $p ? route('admin.pages.update', $p) : route('admin.pages.store') }}">
    ...
    <div class="apc-card">
        <div class="card-body p-3 p-md-4">
            <div class="row g-3">
                <div class="col-md-4 apc-field"><label class="apc-label">Slug <span class="text-danger">*</span></label><input type="text" name="slug" value="{{ old('slug', $p?->slug) }}" class="apc-input" required></div>
                ...
                <div class="col-12 apc-field"><label class="apc-label">Konten</label><textarea name="content" rows="14" class="apc-textarea">{{ old('content', $p?->content) }}</textarea></div>
                <div class="col-12">
    ...
    <div class="d-flex gap-2 mt-4">
        ...
        <a href="{{ route('admin.pages.index') }}" class="apc-btn apc-btn-ghost">Batal</a>
    </div>
</form>