...
@section('content')
    <x-admin::page-header title="Edit Pembayaran">
    ...
    <form method="POST" action="{{ route('admin.payments.update', $payment) }}">
        ...
        <div class="apc-card" style="max-width: 700px;">
            <div class="card-body p-3 p-md-4">@include('admin.payments._form', ['orders' => $orders, 'payment' => $payment, 'selected' => $payment->order])</div>
        </div>
